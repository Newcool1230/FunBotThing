		...
		if(data.message.indexOf('!') === 0 || data.message.indexOf('.') === 0){
			...
			if(Funbot.misc.ready || Funbot.admins.indexOf(uid) > -1 || API.getUser(data.uid).permission > 1 || API.getUser(uid).permission < 2){
				...
				switch(command[0].toLowerCase()){
					...
					case "test":
						API.sendChat("[NoBot] @" + un + ", stahp I'm busy");
						break;
					...
					case "eta":
					 ...
					 case "dogfact":
							if(typeof command[1] == "undefined"){
								...
								switch(randomSentence){
									case 0:
										API.sendChat("[NoBot] @" + un + " " + Funbot.misc.dogfact[randomDogfact]);
										break;
									case 1:
										API.sendChat("[NoBot] @" + un + " " + Funbot.misc.dogfact[randomDogfact]);
										break;
								...
								switch(randomSentence){
									case 0:
										API.sendChat("[NoBot] @" + command[1] + " " + Funbot.misc.dogfact[randomdogfact]);
										break;
									case 1:
										API.sendChat("[NoBot] @" + command[1] + " " + Funbot.misc.dogfact[randomDogfact]);
										break;
						...
						case "catfact":
							if(typeof command[1] == "undefined"){
								...
								switch(randomSentence){
									case 0:
										API.sendChat("[NoBot] @" + un + " " + Funbot.misc.catfact[randomCatfact]);
										break;
									case 1:
										API.sendChat("[NoBot] @" + un + " " + Funbot.misc.catfact[randomCatfact]);
										break;
								...
								switch(randomSentence){
									case 0:
										API.sendChat("[NoBot] @" + command[1] + " " + Funbot.misc.catfact[randomCatfact]);
										break;
									case 1:
										API.sendChat("[NoBot] @" + command[1] + " " + Funbot.misc.catfact[randomCatfact]);
										break;
